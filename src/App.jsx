    ...
    <>
      <Section>
        <img
          ...
          alt="ivan"
        />
        <h1 className="name">Ivan Silvestre</h1>
        <h5 className="description">🇵🇹 web developer && musician 🎷</h5>
        <Card
          title="Bluesky"
        ...
        />
        <div class="scroll-info">to say hi by email...</div>
        <div>( scroll page down )</div>
      </Section>
      <Section>
        <form
        ...
        <div className="scroll-info">back to main page</div>
        <div>( scroll page up )</div>
      </Section>
    </>
  );
};
